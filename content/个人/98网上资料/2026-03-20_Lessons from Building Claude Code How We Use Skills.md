...
**作者**: Thariq (@trq212)
**时间**: 2026-03-18T00:53:00
**来源**: [原始链接](https://x.com/trq212/status/2033949937936085378)
...
A common misconception we hear about skills is that they're "just markdown files", but the most interesting part of skills is that they're not just text files. They're folders that can include scripts, assets, data, etc. that the agent can discover, explore and manipulate.
...
Claude can then generate scripts on the fly to compose this functionality to do more advanced analysis.
...
Examples:
- /careful — blocks rm -rf, DROP TABLE, force-push, kubectl delete via PreToolUse matcher on Bash. You only want this when you know you're touching prod
- /freeze — blocks any Edit/Write that's not in a specific directory. Useful when debugging
...
![Image 1](https://pbs.twimg.com/media/HDl2jn9a0AAZkyz?format=jpg&name=medium)

![Image 2](https://pbs.twimg.com/media/HDlvMmubEAIzF-N?format=jpg&name=medium)

![Image 3](https://pbs.twimg.com/media/HDoKg58bEAAL1bw?format=jpg&name=medium)

![Image 4](https://pbs.twimg.com/media/HDlwEG1bEAUdmcV?format=jpg&name=medium)

![Image 5](https://pbs.twimg.com/media/HDlwhSjbEAIJSc9?format=jpg&name=medium)

![Image 6](https://pbs.twimg.com/media/HDlwurvbEAM5ZNu?format=jpg&name=medium)

![Image 7](https://pbs.twimg.com/media/HDlw1mYbEAY-Bul?format=jpg&name=medium)

![Image 8](https://pbs.twimg.com/media/HDlw5ULbEAQOqtJ?format=jpg&name=medium)

![Image 9](https://pbs.twimg.com/media/HDoImh1bEAU-mMI?format=jpg&name=medium)

![Image 10](https://pbs.twimg.com/media/HDlxbtkbkAAOse7?format=jpg&name=medium)

![Image 11](https://pbs.twimg.com/media/HDlxfEIb0AA2E7l?format=jpg&name=medium)
