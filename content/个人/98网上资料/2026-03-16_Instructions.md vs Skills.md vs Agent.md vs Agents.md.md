---
title: Instructions.md vs Skills.md vs Agent.md vs Agents.md
...
**时间**: 2026-03-16 12:43
**来源**: [原始链接](https://x.com/pvergadia/status/2033403840264126816)
...
Where does it fit among all the other agents?
...
---
name: web-scraper
description: Extracts structured data from websites using BeautifulSoup and Playwright. Use when asked to scrape tables, listings, or articles.
---
...
![Image 1](https://pbs.twimg.com/media/HDgY_nxaUAARsSl?format=jpg&name=small)

![Image 2](https://pbs.twimg.com/media/HDgZLkUbcAEbYw2?format=jpg&name=small)

![Image 3](https://pbs.twimg.com/media/HDgZUh0aYAAlWI7?format=jpg&name=small)
