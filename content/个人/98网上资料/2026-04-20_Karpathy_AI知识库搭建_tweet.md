...
source: "https://x.com/imaxichuhai/status/2046071513779200275"
platform: "X/Twitter"
...
tags:
  ...
  - 知识管理
  - AI工具
cover: "https://pbs.twimg.com/media/HGUa-mbakAAxHX-.jpg"
---
...
其实就是一个叫 CLAUDE.md 的文件，像一本使用手册一样告诉 AI 这个知识库长什么样、该怎么工作。这一层是你和 AI 共同维护的约定。
...
AI 会自动读取这份文档，然后帮你创建 raw（原始资料）、wiki（知识网络），还有 CLAUDE.md 文件。
