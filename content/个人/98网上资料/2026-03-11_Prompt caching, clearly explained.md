...
**时间**: 2026-03-09 14:58
**来源**: [原始链接](https://x.com/akshay_pachaar/status/2031021906254766128)
...
**The static prefix:** includes system instructions, tool definitions, project context, behavioral guidelines. This content is identical across every single turn of a session.
...
The math only works if your cache hit rate stays high.
...
You type your first instruction. Claude Code dispatches an Explore Subagent. It navigates through the codebase, opens files, runs grep commands, and builds a picture of the relevant code. All of this gets appended to the dynamic tail.
...
In practice, you'd expect somewhere in the range of an 80%+ cost reduction on a single task.
...
The infrastructure hashes the prompt. The hash changes if anything in that order changes, even if two elements are in a different order. The cache is empty. The whole prefix is recalculated at full price.
...
1. At the top are system instructions and rules. Don't change in the middle.
2. Load all the tools you'll need ahead of time. Don't add or take them away.
3. Retrieved context and documents after that. Static for the duration.
4. At the bottom, the history of the conversation and the tool's outputs.
...
![Image 1](https://pbs.twimg.com/media/HC4X8E1bUAAfW1k?format=jpg&name=medium)

![Image 2](https://pbs.twimg.com/media/HC4QeNhakAAbC-4?format=jpg&name=medium)

![Image 3](https://pbs.twimg.com/media/HC4RovSbEAAzdLN?format=jpg&name=medium)

![Image 4](https://pbs.twimg.com/media/HC4R_cIaUAAZD58?format=png&name=medium)

![Image 5](https://pbs.twimg.com/media/HC4Ui7LbIAA7DUd?format=png&name=medium)

![Image 6](https://pbs.twimg.com/media/HC4VOQhaMAAjc7R?format=jpg&name=medium)

![Image 7](https://pbs.twimg.com/media/HC4W8g-aQAAnjIQ?format=jpg&name=medium)

![Image 8](https://pbs.twimg.com/media/HC4XE02a4AERwc1?format=jpg&name=medium)
