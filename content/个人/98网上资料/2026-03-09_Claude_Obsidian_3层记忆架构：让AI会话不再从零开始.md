---
doc_type: tweet-save
tweetId: "2030904887186514336"
tweetUrl: "https://x.com/nyk_builderz/status/2030904887186514336"
author: Nyk 🌱 @nyk_builderz
date: 2026-03-09
source: Twitter/X
tweetStats: 112万阅读, 169转帖, 1719喜欢, 6879书签, 52回复
tags: [AI, Memory, Claude, Obsidian, KnowledgeManagement, Agent]
---
...
Then there's the auto-memory directory. This is where Claude persists observations across sessions — patterns it noticed, solutions that worked, and things you corrected it on.
...
You don't need Obsidian for knowledge management with Claude Code — you need markdown files with wikilinks in folders. Obsidian is one good interface for that. The graph is what matters.
...
**You need:**
- Wikilinks as semantic connections
- Atomic composable markdown notes
- Maps of content for navigation and attention management
...
> we learned that [[memory graphs beat giant memory files]] when we [[benchmark retrieval like search infrastructure]]
...
Most knowledge doesn't start as text in your vault. It starts as a YouTube video, a conference talk, a voice memo, a podcast episode. The gap between... [内容截断，原文完整]
...
**Brain-ingest** closes the gap. What happens under the hood:
...
**Source:** [Nyk @nyk_builderz](https://x.com/nyk_builderz/status/2030904887186514336) | 112万阅读, 2026-03-09
